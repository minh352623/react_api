      ...
      var Game = {
        ...
        gameOver: async function () {
          ...
          if (Game.score > 0) {
            ...
            formData.append("coin", Game.score);
            //call api
            try {
              ...
              if (response) {
                ...
                if (user.coin_dif) {
                  cookies.set("user", {
                    ...
                    coin_dif: {
                      ...user.coin_dif,
                      coin: +user.coin_dif.coin + Game.score,
                    },
                  });
                  dispatch(
                    setUser({
                  ...
                  cookies.set("user", {
                    ...user,
                    coin_dif: { ...user.coin_dif, coin: Game.score },
                  });
                  dispatch(
                    setUser({
                      ...user,
      ...
      <div className="game-wrap">
        ...
        <article className="content">
          ...
          <span
            ...
            class="px-4 py-2  cursor-pointer bg-slate-600 rounded-lg text-pink-500"
          >
            Go Home
          </span>
          {/* <p>
            <a href="https://codepen.io/natewiley/full/EGyiF" target="_blank">
              Click here to play in full mode
            </a>
            , click the game to pause and take a break.{" "}
            <a href="https://codepen.io/natewiley" target="_blank">
